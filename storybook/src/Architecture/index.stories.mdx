...
The core provides the foundation on which developers can build gluestack apps. The foundation includes an initial folder structure and a local CLI that helps them manage plugins.
